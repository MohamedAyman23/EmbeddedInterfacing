...
# 1 "MCAL_Layer/GPIO/../std_libararies.h" 1
# 11 "MCAL_Layer/GPIO/../std_libararies.h"
...
# 11 "MCAL_Layer/GPIO/../std_libararies.h" 2
...
# 12 "MCAL_Layer/GPIO/../std_libararies.h" 2
...
# 13 "MCAL_Layer/GPIO/../std_libararies.h" 2
...
Std_ReturnType gpio_pin_git_direction_status(const pin_config_t *_pin_config, direction_t *dir_status){
    ...
    if(((void*)0) == _pin_config || (_pin_config->pin > 8 -1)){
        ...
        *dir_status = (((*tris_registers[_pin_config->port]) >> (_pin_config->pin)) & (uint8)0x01);
    }
    return ret;
}
# 69 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_write_logic(const pin_config_t *_pin_config, logic_t logic){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == _pin_config || (_pin_config->pin > 8 -1)){
        ret = (Std_ReturnType)0x00;
...
# 177 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_port_git_direction_status(port_index_t port, uint8 *direction_status){
    Std_ReturnType ret = (Std_ReturnType)0x01;
